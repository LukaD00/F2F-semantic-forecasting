...
class ConvF2F(nn.Module):	
	...
	def __init__(self, output_channels=128, num_past=4, layers=8):
		...
		self.layers.append(nn.Conv2d(in_channels = num_past * output_channels, out_channels=256, kernel_size=1, padding=0))
		...
		self.layers.append(nn.Conv2d(in_channels=128, out_channels = output_channels, kernel_size=3, padding=1))
		self.layers.append(nn.ReLU())
